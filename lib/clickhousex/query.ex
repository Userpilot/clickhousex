...
defimpl DBConnection.Query, for: Clickhousex.Query do
  ...
  @doc """
    Special handling for zero-param SELECT or ALTER or UPDATE queries (i.e. raw queries) indicated by
    `type: :select or :alter or :update` and `param_count: 0` where the encoded query statement is to placed
